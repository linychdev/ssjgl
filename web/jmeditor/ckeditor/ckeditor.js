...
(function() {
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    i.guard = function(b, i) {
                        if (l(b)) return true;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || i && b.equals(p) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary()) return false; ! i && b.type == CKEDITOR.NODE_ELEMENT && (p = b);
                        return true
                    };
                    ...
                    if (h) {
                        i.reset(); (i = i[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward": "previous"]()) && this.setEndAt(i, b ? CKEDITOR.POSITION_BEFORE_END: CKEDITOR.POSITION_AFTER_END)
                    }
                    return ! (!k && !h)
                }
            },
            ...
            splitBlock: function(a) {
                ...
                if (i && i.equals(d)) if (b) {
                    ...
                    d = this.splitElement(i); ! CKEDITOR.env.ie && !i.is("ul", "ol") && i.appendBogus()
                }
                return {
                    previousBlock: i,
                    nextBlock: d,
        ...
        return {
            load: function(a, f, e, d) {
                ...
                if (k === 0) m(true);
                    ...
                    var n = function(a, b) { (b ? h: l).push(a);
                        if (--k <= 0) {
    ...
    CKEDITOR.event.implementOn(CKEDITOR.ui); (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            destroy: function(a) {
                this.fire("beforeDestroy"); ! a && l.call(this);
                this.editable(null);
                this.fire("destroy");
                this.removeAllListeners();
            ...
            setKeystroke: function() {
                ...
                b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], c, d, n = b.length; n--;) {
                    c = b[n];
                    d = 0;
                ...
                g; f = this._.htmlPartsRegex.exec(a);) {
                    ...
                    if (g) g.push(f[0]);
                        ...
                        if (!/="/.test(e)) {
                            ...
                            this.onTagOpen(e, k, l); ! g && CKEDITOR.dtd.$cdata[e] && (g = [])
                        }
    ...
    CKEDITOR.htmlParser.fragment = function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(e, d, g) {
            ...
            function m(a, c, d) {
                ...
                if (a.previous === void 0) {
                    ...
                    l(a); (!b(a) || a.children.length) && c.add(a);
                    a.name == "pre" && (A = false);
                    ...
                    if (d == "br") z.push(n);
                        ...
                        for (;;) {
                            ...
                            if (!n.isUnknown && !j.isUnknown && !e[d]) if (j.isOptionalClose) i.onTagClose(g);
                                ...
                                g = j.children; (g = g[g.length - 1]) && g.name == "li" || m(g = new CKEDITOR.htmlParser.element("li"), j); ! n.returnPoint && (n.returnPoint = j);
                                j = g
                            } else if (d in CKEDITOR.dtd.$listItem && !o(d, g)) i.onTagOpen(d == "li" ? "ul": "dl", {},
                            0, 1);
                            else if (g in c && !o(d, g)) { ! n.returnPoint && (n.returnPoint = j);
                                j = j.parent
                            } else {
        ...
        function j(a, b) {
            for (var c = [], d = b.config.protectedSource, n = b._.dataStore || (b._.dataStore = {
                id: 1
            }), i = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(d), a = a.replace(/<\!--[\s\S]*?--\>/g,
            function(a) {
                return "<\!--{cke_tempcomment}" + (c.push(a) - 1) + "--\>"
            }), o = 0; o < d.length; o++) a = a.replace(d[o],
            function(a) {
                a = a.replace(i,
                function(a, b, d) {
                    return c[d]
            ...
            writeHtml: function(c, a) {
                ...
                if (a) {
                    ...
                    for (;;) {
                        ...
                        if (!d) {
                            for (var d = 0,
                            m = this.children.length; d < m; d++) this.children[d].parent = e.parent;
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElement: function(b) {
                    ...
                    f = c.getSelection(), h = f.getRanges(), l = b.getName(), j = CKEDITOR.dtd.$block[l], m, k, B, p = h.length - 1; p >= 0; p--) {
                        m = h[p];
                        if (!m.checkReadOnly()) {
                            m.deleteContents(1);
                            k = !p && b || b.clone(1);
                            var D, u;
                            if (j) for (; (D = m.getCommonAncestor(0, 1)) && (u = CKEDITOR.dtd[D.getName()]) && (!u || !u[l]);) if (D.getName() in CKEDITOR.dtd.span) m.splitElement(D);
                    ...
                    if (u) {
                        ...
                        for (h(I, E); w < I.length; w++) {
                            ...
                            if (x) v = w > 0;
                                ...
                                if (G.lastNotAllowed && w < I.length - 1) { (O = Q ? t: O) && E.setEndAt(O, CKEDITOR.POSITION_AFTER_START);
                                    r = 0
                                }
                                E.collapse()
                            }
            ...
            getRanges: function() {
                ...
                function() {
                    ...
                    var b = function(b, c) {
                        ...
                        g, i, h = b.duplicate(), n = 0, l = f.length - 1, m = -1, k, v; n <= l;) {
                            m = Math.floor((n + l) / 2);
                            g = f[m];
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                for (k.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (k = 0); k;) {
                        ...
                        if (!r || i[r] && !s && (!q || h) && (k.getPosition(m) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(k))) {
                            ...
                            if (u && ((u.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(u))) {
                                ...
                                if (p == CKEDITOR.NODE_TEXT || q || p == CKEDITOR.NODE_ELEMENT && !k.getChildCount()) {
                                    for (var p = k,
                                    v; (g = !p.getNext(F)) && (v = p.getParent(), i[v.getName()]) && (v.getPosition(j) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(v));) p = v;
                                    n.setEndAfter(p)
                                }
                            } else g = true
                        } else g = true;
                    ...
                    if (g && n && !n.collapsed) {
                        for (var g = y(this, c), q = g.hasAttributes(), s = n.getCommonAncestor(), p = {},
                        r = {},
                        u = {},
                        z = {},
                        A, B, D; g && s;) {
                    ...
                    getNextRange: function(g) {
                        ...
                        if (k && a.length > 1) {
                            ...
                            if (g) for (var l = 0; a[d + l + 1];) {
                                ...
                                g = 0,
                                h = m.getById(c[l].endNode), m = m.getById(c[l + 1].startNode);;) {
...
*/
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                showBlock: function(a, b, c, g, i) {
                    ...
                    this._.blurSet || (b = CKEDITOR.env.ie ? a: new CKEDITOR.dom.window(a.$.contentWindow), CKEDITOR.event.useCapture = !0, b.on("blur",
                    function(a) {
                    ...
                    CKEDITOR.tools.setTimeout(function() {
                        var a = CKEDITOR.tools.bind(function() {
                            ...
                            var a = d.getFirst(),
                            m; (m = a.getCustomData("activePanel")) && m.onHide && m.onHide.call(this, 1);
    ...
    CKEDITOR.plugins.add("menu", {
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function(a, c) {
                ...
                i = b.block.attributes = b.attributes || {}; ! i.role && (i.role = "menu");
                ...
                onShow: function() {
                    ...
                    for (var e = 0; e < i.length; e++) {
                        ...
                        if (j) for (var f in j) {
                            ...
                            if (h && (!h.command || this.editor.getCommand(h.command).state)) h.state = j[f],
                            this.add(h)
                        }
                    }
                },
            ...
            if (!1 !== a.resize_enabled) {
                ...
                function(a) {
                    if ("bottom" == a.data.space) {
                        var d = "";
                        i && !l && (d = " cke_resizer_horizontal"); ! i && l && (d = " cke_resizer_vertical");
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                ...
                o = CKEDITOR.tools.addFunction(function(a) {
                    if (c.onkey) return a = new CKEDITOR.dom.event(a),
                    !1 !== c.onkey(c, a.getKeystroke())
                }),
                ...
                } else if (d && (d = a.getCommand(d))) d.on("state",
                function() {
    ...
    CKEDITOR.tools.extend(CKEDITOR.config, {
        ...
        function $(a) {
            ...
            function(b) {
                ...
                a.editor.focus(); ! p.ie && a.enterMode != CKEDITOR.ENTER_BR && a.hotNode.scrollIntoView();
        ...
        function T(a) {
            ...
            } else f.equals(a.editable[i ? "getLast": "getFirst"](a.isRelevant)) ? (z(a), i && b.y > f.size.bottom - e && b.y < d.pane.height && f.size.bottom > d.pane.height - e && f.size.bottom < d.pane.height ? h = v: 0 < b.y && b.y < f.size.top + e && (h = u)) : h = q,
            c = [null, f][i ? "reverse": "concat"]().concat([i ? S: A, C, h, f.equals(a.editable[i ? "getLast": "getFirst"](a.isRelevant)) ? i ? v: u: q]);
        ...
        function I(a, b, d, e) {
            ...
            j = {},
            k = {},
            g = r.length; g--;) h[r[g]] = parseInt(f("border-" + r[g] + "-width"), 10) || 0,
            j[r[g]] = parseInt(f("padding-" + r[g]), 10) || 0,
            i[r[g]] = parseInt(f("margin-" + r[g]), 10) || 0; (!d || e) && D(a, e);
        ...
        function ca(a, b, d, e) {
            ...
            g = a.mouse; g.y + h < k && 0 < g.y - h;) {
                i || (i = b(f, e));
                j || (j = b(c, e)); ! i && 0 < g.y - h && (f = d(a, {
                    x: g.x,
                    y: g.y - h
                })); ! j && g.y + h < k && (c = d(a, {
                    x: g.x,
            ...
            init: function(a) {
                ...
                function() {
                    ...
                    b.is(CKEDITOR.dtd.$inline) || (c.inInlineMode && !Q(b) && b.setStyles({
                        ...
                        top: null,
                        left: null
                    }), $.call(this, c), D(c), b.attachListener(a, "beforeUndoImage",
                    function() {
                        c.line.detach()
                    ...
                    null, null, 0), b.attachListener(c.inInlineMode ? d: d.getWindow().getFrame(), "mouseout",
                    function(b) {
                        if ("wysiwyg" == a.mode) if (clearTimeout(i), c.inInlineMode) {
                            ...
                            f = c.view.scroll;
                            if (! (d > e.left - f.x && d < e.right - f.x) || !(b > e.top - f.y && b < e.bottom - f.y)) clearTimeout(k),
                            k = null,
                            c.line.detach()
                        } else clearTimeout(k),
                        k = null,
                        i = CKEDITOR.tools.setTimeout(c.line.detach, 150, c.line)
                    ...
                    }), b.attachListener(c.inInlineMode ? b: d, "mousemove",
                    function(b) {
                        clearTimeout(i);
                        j = !0;
                        if (! ("wysiwyg" != a.mode || k)) {
                            ...
                            k = setTimeout(function() {
                                ...
                                k = c.trigger = null;
                                D(c);
                                if (j && !c.hiddenMode && a.focusManager.hasFocus && !c.line.mouseNear() && (c.element = W(c, !0)))(c.trigger = R(c) || T(c) || X(c)) ? c.line.attach().place() : (c.trigger = null, c.line.detach()),
                                j = !1
                            },
                            30)
                        }
                    }), b.attachListener(e, "scroll",
                    function() {
                        "wysiwyg" == a.mode && (c.line.detach(), p.webkit && (c.hiddenMode = 1, clearTimeout(h), h = setTimeout(function() {
                            c.hiddenMode = 0
                        },
                        50)))
                    }), b.attachListener(e, "mousedown",
                    function() {
                        "wysiwyg" == a.mode && (c.line.detach(), c.hiddenMode = 1)
                    }), b.attachListener(e, "mouseup",
                    function() {
                        c.hiddenMode = 0
                    }), this.backdoor = {
                        accessFocusSpace: P,
        ...
        X = function() {
            function a(a) {
                ...
                i, j, k, g; c && !c.equals(f) && (j = f.getNext(a.isRelevant));) i = Math.abs(Z(a, f, j) - a.mouse.y),
                i < e && (e = i, k = f, g = j),
                f = j,
                m(a, f);
    ...
    CKEDITOR.plugins.removeformat = {
        ...
        filter: function(a, h) {
            for (var e = a._.removeFormat.filters,
            f = 0; f < e.length; f++) if (!1 === e[f](h)) return ! 1;
            return ! 0
        }
    };
        ...
        function o(c) {
            ...
            e = 0; e < c.length; e++) {
                ...
                (f = f.getAscendant("td", !0) || f.getAscendant("th", !0)) && b.push(f);
                    ...
                    g;
                    for (f.guard = d; g = f.next();) if ((g = g.getAscendant("td") || g.getAscendant("th")) && !g.getCustomData("selected_cell")) CKEDITOR.dom.element.setMarker(a, g, "selected_cell", !0),
                    b.push(g)
                }
            }
