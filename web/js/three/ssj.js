...
$(function(){
	var table = [
	             ...
	             "La", "hcp", "Lanthanum", 4, 8.2, "rgba(51,153,255,",
	             "Ce", "fcc", "Cerium", 5, 8.2, "rgba(51,153,255,",
	             "Pr", "hcp", "Praseodymium", 6, 8.2, "rgba(51,153,255,",
	             "Nd", "hcp", "Neodymium", 7, 8.2, "rgba(51,153,255,",
	             "Pm", "hcp", "Promethium", 8, 8.2, "rgba(51,153,255,",
	             "Sm", "trigonal", "Samarium", 9, 8.2, "rgba(51,153,255,",
	             "Eu", "bcc", "Europium", 10, 8.2, "rgba(51,153,255,",
	             "Gd", "hcp", "Gadolinium", 11, 8.2, "rgba(51,153,255,",
	             "Tb", "hcp", "Terbium", 12, 8.2, "rgba(51,153,255,",
	             "Dy", "hcp", "Dysprosium", 13, 8.2, "rgba(51,153,255,",
	             "Ho", "hcp", "Holmium", 14, 8.2, "rgba(51,153,255,",
	             "Er", "hcp", "Erbium", 15, 8.2, "rgba(51,153,255,",
	             "Tm", "hcp", "Thulium", 16, 8.2, "rgba(51,153,255,",
	             "Yb", "fcc", "Ytterbium", 17, 8.2, "rgba(51,153,255,",
	             "Lu", "hcp", "Lutetium", 18, 8.2, "rgba(51,153,255,",
	             ...
	             "Ac", "", "Actinium", 4, 9.2, "rgba(51,153,255,",
	             "Th", "fcc", "Thorium", 5, 9.2, "rgba(51,153,255,",
	             "Pa", "", "Protactinium", 6, 9.2, "rgba(51,153,255,",
	             "U", "cubic", "Uranium", 7, 9.2, "rgba(51,153,255,",
	             "Np", "", "Neptunium", 8, 9.2, "rgba(51,153,255,",
	             "Pu", "", "Plutonium", 9, 9.2, "rgba(51,153,255,",
	             "Am", "", "Americium", 10, 9.2, "rgba(51,153,255,",
	             "Cm", "", "Curium", 11, 9.2, "rgba(51,153,255,",
	             "Bk", "", "Berkelium", 12, 9.2, "rgba(51,153,255,",
	             "Cf", "", "Californium", 13, 9.2, "rgba(51,153,255,",
	             "Es", "", "Einstenium", 14, 9.2, "rgba(51,153,255,",
	             "Fm", "", "Fermium", 15, 9.2, "rgba(51,153,255,",
	             "Md", "", "Mendelevium", 16, 9.2, "rgba(51,153,255,",
	             "No", "", "Nobelium", 17, 9.2, "rgba(51,153,255,",
	             "Lr", "", "Lawrencium", 18, 9.2, "rgba(51,153,255,",
...
//var winHeigth =$("#elements_sk").height();
...
//	ele2.attr("style","visibility:hidden;margin-top:145px;");
...
//		y = top+$(".input-group").height()+10;
//		x = $(".input-group").offset().left;
//		object.position.x = -winWidth;
//		object.position.y = 0;
